...
var Ittybit = /** @class */ (function () {
    function Ittybit(config) {
        ...
        this.endpoint = {
            image: {
                list: '/images',
                get: function (id) { return "/image/" + id; },
            },
            video: {
                list: '/videos',
                get: function (id) { return "/video/" + id; },
            },
        };
    ...
    // Headers
    Ittybit.prototype.request = function (endpoint, method) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        images = _a.sent();
                        if (images.code === 200)
                            return [2 /*return*/, images.payload];
                        else
                            throw new Error(images.payload.error.message);
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        videos = _a.sent();
                        if (videos.code === 200)
                            return [2 /*return*/, videos.payload];
                        else
